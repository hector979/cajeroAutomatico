...
class CajeroAutomatico:
    ...
    def _inicializar_usuarios_demo(self):
        ...
        cuenta_nomina = CuentaNomina("003", "Carlos López", 750000, "Tech Corp")
        usuario3.agregar_cuenta(cuenta_nomina)
        self._usuarios["003"] = usuario3

         # Usuario 4: Con cuenta nómina
        usuario4 = Usuario("Hector Benavides", "5555")
        cuenta_nomina = CuentaNomina("005", "Hector Benavides", 22000000, "Tech Corp")
        usuario4.agregar_cuenta(cuenta_nomina)
        self._usuarios["005"] = usuario4

        # Usuario 5: Con cuenta nómina
        usuario5 = Usuario("Gayson Gallego", "5562")
        cuenta_nomina = CuentaNomina("006", "Gayson Gallego", 100, "Tech Corp")
        usuario5.agregar_cuenta(cuenta_nomina)
        self._usuarios["006"] = usuario5
...
if __name__ == "__main__":
    try:
        ...
        print("   • Hector Benavides - Cuenta: 005 - PIN: 5555")
        print("   • Gayson Gallego - Cuenta: 006 - PIN: 5562")
